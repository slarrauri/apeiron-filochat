...
import 'filosofos_description_model.dart';
export 'filosofos_description_model.dart';

class FilosofosDescriptionWidget extends StatefulWidget {
  const FilosofosDescriptionWidget({Key? key}) : super(key: key);

  @override
  _FilosofosDescriptionWidgetState createState() =>
      _FilosofosDescriptionWidgetState();
}

class _FilosofosDescriptionWidgetState extends State<FilosofosDescriptionWidget>
    with TickerProviderStateMixin {
  late FilosofosDescriptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilosofosDescriptionModel());
